...
CGXByteBuffer& CGXDLMSPppSetup::GetUserNamePPP()
{
    return m_UserName;
}

void CGXDLMSPppSetup::SetUserNamePPP(CGXByteBuffer& value)
{
    m_UserName = value;
}
...
CGXByteBuffer& CGXDLMSPppSetup::GetPasswordPPP()
{
    return m_Password;
}

void CGXDLMSPppSetup::SetPasswordPPP(CGXByteBuffer value)
{
    m_Password = value;
}
